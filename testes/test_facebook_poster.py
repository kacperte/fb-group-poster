...
class TestFacebookPoster(unittest.TestCase):
 ...
 def test_move_cursor_direction_start_and_correct_it(self):
     ...
     position = None
     to_move = None
     selenium_element, n = self.my_class.create_selenium_object_for_testing(content, direction)
     expected_result = 4
 ...
 def test_move_cursor_direction_end_and_correct_it(self):
     ...
     result = self.my_class.move_cursor(
         content, selenium_element, direction, position, to_move, n_for_end_and_position=n
     )
